...
export default function DocsPage() {
    ...
    <>
      ...
      <section id="architecture" className="animate-fade-in-up motion-reduce:animate-none [animation-delay:60ms]">
        ...
        <ul>
          ...
          <li>
            <strong>Object storage</strong> (external S3-compatible provider): optional presigned uploads for large files from the
            dashboard flow.
          </li>
          <li>
  ...
  "files": []
      ...
      <section id="settings">
        ...
        <p>
          <strong>Storage credentials</strong> — Configure your external S3 endpoint, bucket, access key, and secret key for presigned uploads.
        </p>
      </section>
