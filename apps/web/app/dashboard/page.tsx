  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50/50">
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {submissionBanner && summary?.latest_submission ? (
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                className="inline-flex items-center justify-center rounded-xl bg-sky-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-800"
        ...
        <Card className="mb-8 border-indigo-200/80 bg-gradient-to-br from-indigo-50 via-white to-violet-50/50">
        ...
        <Card className="mb-8 border-indigo-200 shadow-lg shadow-indigo-100/50">
